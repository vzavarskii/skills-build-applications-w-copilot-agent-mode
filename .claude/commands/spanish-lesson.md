...
3. Покажи итоги:
   - ✅ Список правильных — для каждого одна короткая фраза-подсказка почему именно так (этимология, когнат, образ)
   - ❌ Список ошибок — для каждого: правильный перевод + подробное объяснение (этимология, чем отличается от ответа пользователя, мнемоника для запоминания)
...
Составь 2–3 предложения на испанском, в которых задействованы все слова урока. Приоритет — слова, где пользователь ошибся или дал неточный ответ: они должны быть в предложениях обязательно. Остальные слова распредели по оставшимся предложениям.

Требования к предложениям:
- Живые, осмысленные, не искусственные
- Сложность — уровень B1: несложный синтаксис, но настоящий испанский
- После каждого предложения — перевод НЕ давать, пользователь переводит сам

Напиши предложения под заголовком `### Переведи предложения`, затем попроси:

> Переведи каждое предложение на русский.

Когда пользователь ответит — проверь перевод (будь снисходителен к стилю, смотри на понимание смысла), дай краткую обратную связь по каждому предложению: что понято верно, где есть неточности.
